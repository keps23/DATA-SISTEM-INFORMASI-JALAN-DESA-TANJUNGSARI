...
var format_jalanyangbelummemilikinama_5 = new ol.format.GeoJSON();
var features_jalanyangbelummemilikinama_5 = format_jalanyangbelummemilikinama_5.readFeatures(json_jalanyangbelummemilikinama_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_jalanyangbelummemilikinama_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_jalanyangbelummemilikinama_5.addFeatures(features_jalanyangbelummemilikinama_5);
var lyr_jalanyangbelummemilikinama_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_jalanyangbelummemilikinama_5, 
                style: style_jalanyangbelummemilikinama_5,
                popuplayertitle: 'jalan yang belum memiliki nama',
                interactive: false,
    title: 'jalan yang belum memiliki nama<br />\
    <img src="styles/legend/jalanyangbelummemilikinama_5_0.png" /> Jalan Lingkungan Primer<br />\
    <img src="styles/legend/jalanyangbelummemilikinama_5_1.png" /> Jalan Lokal Primer<br />\
    <img src="styles/legend/jalanyangbelummemilikinama_5_2.png" /> Jalan Lokal Sekunder<br />\
    <img src="styles/legend/jalanyangbelummemilikinama_5_3.png" /> Jalan Setapak<br />\
    <img src="styles/legend/jalanyangbelummemilikinama_5_4.png" /> Jalan Tol<br />' });

lyr_OSMStandard_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_BATASDESA_2.setVisible(true);lyr_BATAS_DESART_3.setVisible(true);lyr_DATASISTEMJALAN_4.setVisible(true);lyr_jalanyangbelummemilikinama_5.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_GoogleSatellite_1,lyr_BATASDESA_2,lyr_BATAS_DESART_3,lyr_DATASISTEMJALAN_4,lyr_jalanyangbelummemilikinama_5];
...
lyr_jalanyangbelummemilikinama_5.set('fieldAliases', {'ID': 'ID', 'KODE JALAN': 'KODE JALAN', 'NAMA DESA': 'NAMA DESA', 'DUKUH': 'DUKUH', 'RW': 'RW', 'RT': 'RT', 'KELAS JALA': 'KELAS JALAN', 'NAMA JALAN': 'NAMA JALAN', 'NAMA SEGME': 'NAMA SEGMEN', 'JENIS PERK': 'JENIS PERKERASAN', 'PANJANG JA': 'PANJANG JALAN', 'LEBAR JALA': 'LEBAR JALAN', 'LUAS SEGME': 'LUAS SEGMEN', 'LUAS RUSAK': 'LUAS RUSAK', 'JENIS KERU': 'JENIS KERUSAKAN', 'LEBAR RETA': 'LEBAR RETAK', 'JUMLAH LUB': 'JUMLAH LUBANG', 'KEDALAMAN': 'KEDALAMAN', 'PENGUKURAN': 'PENGUKURAN', 'SDI1': 'SDI1', 'SDI2': 'SDI2', 'SDI3': 'SDI3', 'SDI4': 'SDI4', 'KONDISI JA': 'KONDISI JALAN', 'SBDATA': 'SUMBER DATA', });
...
lyr_jalanyangbelummemilikinama_5.set('fieldImages', {'ID': 'TextEdit', 'KODE JALAN': 'TextEdit', 'NAMA DESA': 'TextEdit', 'DUKUH': 'TextEdit', 'RW': 'TextEdit', 'RT': 'TextEdit', 'KELAS JALA': 'TextEdit', 'NAMA JALAN': 'TextEdit', 'NAMA SEGME': 'TextEdit', 'JENIS PERK': 'TextEdit', 'PANJANG JA': 'TextEdit', 'LEBAR JALA': 'TextEdit', 'LUAS SEGME': 'TextEdit', 'LUAS RUSAK': 'TextEdit', 'JENIS KERU': 'TextEdit', 'LEBAR RETA': 'TextEdit', 'JUMLAH LUB': 'TextEdit', 'KEDALAMAN': 'Hidden', 'PENGUKURAN': 'Hidden', 'SDI1': 'Hidden', 'SDI2': 'Hidden', 'SDI3': 'Hidden', 'SDI4': 'Hidden', 'KONDISI JA': 'TextEdit', 'SBDATA': 'TextEdit', });
...
lyr_jalanyangbelummemilikinama_5.set('fieldLabels', {'ID': 'header label - visible with data', 'KODE JALAN': 'header label - visible with data', 'NAMA DESA': 'header label - visible with data', 'DUKUH': 'header label - visible with data', 'RW': 'header label - visible with data', 'RT': 'header label - visible with data', 'KELAS JALA': 'header label - visible with data', 'NAMA JALAN': 'header label - visible with data', 'NAMA SEGME': 'header label - visible with data', 'JENIS PERK': 'header label - visible with data', 'PANJANG JA': 'header label - visible with data', 'LEBAR JALA': 'header label - visible with data', 'LUAS SEGME': 'header label - visible with data', 'LUAS RUSAK': 'header label - visible with data', 'JENIS KERU': 'header label - visible with data', 'LEBAR RETA': 'header label - visible with data', 'JUMLAH LUB': 'header label - visible with data', 'KONDISI JA': 'header label - visible with data', 'SBDATA': 'header label - visible with data', });
lyr_jalanyangbelummemilikinama_5.on('precompose', function(evt) {
