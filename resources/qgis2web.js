...
map.getView().fit([12319575.821412, -841689.817841, 12322967.430558, -837787.480508], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DATA SISTEM JALAN DESA TANJUNGSARI</h2>';
        return titleElement;
    })(),
